...
> = {
  ...
  idp: { nameUk: 'Внутрішньо переміщена особа (ВПО)', nameRu: 'Внутренне перемещенное лицо (ВПО)', nameEn: 'Internally Displaced Person', ratePeriod1: 0.07, ratePeriod2: 0.10, maxBuildingAge: 10, frontlineMaxBuildingAge: 20 },
